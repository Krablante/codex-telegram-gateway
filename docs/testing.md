...
- `node --test test/codex-runner.test.js test/codex-runner-common.test.js test/codex-runner-lifecycle.test.js test/codex-runner-recovery.test.js` — focused codex-runner ownership slices for helper exports, live turn lifecycle, late-final ordering after `turn/completed`, and rollout recovery
