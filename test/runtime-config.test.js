...
test("buildRuntimeConfig validates ids and splits expected topics", () => {
  const config = buildRuntimeConfig({
    ...
    ATLAS_WORKSPACE_ROOT: "/home/example/workspace",
    DEFAULT_SESSION_BINDING_PATH: "/home/example/workspace",
  ...
  assert.equal(config.workspaceRoot, "/home/example/workspace");
  assert.equal(config.atlasWorkspaceRoot, "/home/example/workspace");
  assert.equal(config.defaultSessionBindingPath, "/home/example/workspace");
